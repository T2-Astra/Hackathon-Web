...
const Footer = () => {
  ...
  return (
    <footer className={`py-16 relative ${isMatrix ? 'bg-transparent text-green-300' : 'bg-[#f8fafc] text-gray-900'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isMatrix ? 'bg-green-900/30 text-green-400 hover:bg-green-800/50 hover:text-green-300' : 'bg-gray-200 text-gray-700 hover:bg-blue-600 hover:text-white'}`}>
          ...
          {/* Quick Links */}
          <div>
            <h4 className={`text-lg font-semibold font-space mb-4 ${isMatrix ? 'text-green-400' : 'text-gray-900'}`}>Quick Links</h4>
            <ul className="space-y-2">
              <li><a href="#home" className={`transition-colors ${isMatrix ? 'text-green-300 hover:text-green-400' : 'text-gray-600 hover:text-gray-900'}`}>Home</a></li>
              <li><a href="#about" className={`transition-colors ${isMatrix ? 'text-green-300 hover:text-green-400' : 'text-gray-600 hover:text-gray-900'}`}>About</a></li>
              <li><a href="#timeline" className={`transition-colors ${isMatrix ? 'text-green-300 hover:text-green-400' : 'text-gray-600 hover:text-gray-900'}`}>Timeline</a></li>
              <li><a href="#prizes" className={`transition-colors ${isMatrix ? 'text-green-300 hover:text-green-400' : 'text-gray-600 hover:text-gray-900'}`}>Prizes</a></li>
              <li><a href="#sponsors" className={`transition-colors ${isMatrix ? 'text-green-300 hover:text-green-400' : 'text-gray-600 hover:text-gray-900'}`}>Sponsors</a></li>
            </ul>
          </div>
